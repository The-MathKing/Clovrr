    ...
    <div className="min-h-screen bg-gray-50 text-gray-900 font-sans">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="bg-white rounded-3xl p-8 md:p-12 shadow-sm border border-gray-200">
          <h1 className="text-3xl font-extrabold text-gray-900 mb-8 pb-4 border-b border-gray-100">Privacy Policy</h1>
          
          <div className="prose prose-emerald max-w-none text-gray-600 space-y-8">
            <p className="text-sm text-gray-400 font-medium">Last Updated: {new Date().toLocaleDateString('en-US', { month: 'long', day: 'numeric', year: 'numeric' })}</p>
            ...
            <section className="bg-emerald-50 p-6 rounded-xl border border-emerald-100">
              <h2 className="text-xl font-bold text-emerald-900 mb-3">2. SMS & Communications Data (Twilio A2P 10DLC Compliance)</h2>
            ...
            <section className="bg-gray-50 p-6 rounded-xl border border-gray-200">
              <h2 className="text-xl font-bold text-gray-900 mb-3">3. AI Data Guardrails</h2>
              <p className="font-medium text-gray-800">
                Data submitted through the Clovrr chat widget, SMS, or any integrated forms is used strictly for routing and booking purposes. <strong>It is not used to train global LLM models.</strong> We ensure this by utilizing enterprise-grade API endpoints (such as OpenAI's API) which default to zero data retention for model training.
              </p>
            </section>

            <section>
              <h2 className="text-xl font-bold text-gray-900 mb-3">4. Information We Collect</h2>
            ...
            <section>
              <h2 className="text-xl font-bold text-gray-900 mb-3">5. How We Use Your Data</h2>
